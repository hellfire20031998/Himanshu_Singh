...
const cardClass =
  'rounded-xl sm:rounded-2xl border border-white/[0.08] bg-zinc-900/40 p-4 sm:p-6 md:p-8 backdrop-blur-xl shadow-[0_4px_40px_rgba(0,0,0,0.35)] transition-all duration-300 hover:border-violet-500/20 hover:shadow-[0_8px_48px_rgba(139,92,246,0.12)]';
        ...
        {Object.values(skillsToRender)
          ...
          .map((skill) => (
            <motion.span
              ...
              layout
              className="tag text-xs sm:text-sm font-medium px-3 py-1.5 sm:px-3.5 sm:py-1.5 rounded-full cursor-default border border-white/[0.1] bg-white/[0.06] text-zinc-200 max-w-full text-center"
            >
              {skill}
            </motion.span>
          ))}
